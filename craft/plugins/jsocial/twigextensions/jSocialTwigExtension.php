      ...
      case 'image':
        switch ($btn) {
          case 'facebook':
            ...
            break;
          case 'twitter':
            $button = "<a style='padding-left:5px;' target='_blank' ". $id ." href='https://twitter.com/intent/tweet?text=". $options['title'] ."&source=sharethiscom&related=sharethis&url=" . $options['url'] . "'><img src='".$options['content'][$btn]['value']."' class='".$options['class-prefix']. $options['content'][$btn]['class'] ."'" . $size . "></a>";
            break;
          case 'linkedin':
